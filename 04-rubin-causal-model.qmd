...
tibble(source = c("Population", "Population", "...",
  ...
  gt() %>%
    tab_header(title = "Population Table") %>% 
    cols_label(source = md("$$\\text{Source}$$"),
               year = md("$$\\text{Year}$$"),
               sex = md("$$\\text{Sex}$$"),
               ytreat = md("$$Y_t(u)$$"),
               ycontrol = md("$$Y_c(u)$$"),

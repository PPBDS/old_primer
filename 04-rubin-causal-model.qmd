...
<!-- Add two more rows from the Preceptor Table to the first Population Table, at least one with a missing outcome. -->
...
<!-- Can't we make math text bolded, and thereby get Y_t(U) on the same level as "Source" and "ID"? If so, fix all the later tables. -->

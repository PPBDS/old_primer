...
* *Vectors*: a series of values. These are created using the `c()` function, where `c()` stands for "combine". For example, `c(6, 11, 13, 31, 90, 92)` creates a six element series of positive integer values.

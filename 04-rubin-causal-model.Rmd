...
Perhaps more importantly, most real world examples involve the future, meaning that specifying the population is impossible. The future is always cloudy. We can't know, perfectly, the population of voters for the next New York City election. There are two main sources of issue: the changing population and the definition of the population. Let's explore what those mean in more depth. 

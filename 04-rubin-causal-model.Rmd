...
Stability has two connotations. First, is Yao changing even if the world is not changing, i.e., he is 80 now and he used to be 20. Second, the world is changing, so Yao's outcome might be different a year from now even if he (in some sense) is the same guy. MF: Done. -->
...
<!-- Maybe there are really three key assumptions in every Data Science Problem: Validity, Stability and Representativeness. Maybe? MF: Done. -->

<!-- Reserve the term "population" for the statistical definition: the imaginary urn from which we draw data, or could have drawn data. MF: Done. -->
...
<!-- MF: To make these sections on validity more sensible, should there be columns for time rather than rows for units at different times? -->
...
Stability means that the relationship between the columns is stable. What does this mean? In short: can we say that this column means the same thing as another column?

...
<!-- New items to discuss at next meeting: -->

<!-- Read Imai pdf for a take on these topics. -->
...
<!--  SZ/AJ: Add many comments with initials. Read the chapter close. -->

<!-- SZ: Learn about captions in R Markdown. Maybe useful: https://bookdown.org/yihui/bookdown/figures.html. One option fig.cap in the cod chunk options. -->

<!-- SZ: Add one or two captions. -->

<!-- SZ/AJ: Do the tutorials. Send me the .rds. -->

<!-- AJ: The multiple choice in the tutorial doesn't seem to properly indicate selected answer -->

<!-- AJ: Maybe replace the one sentence answers with multiple choice -->

<!-- AJ: Make multiple choice more clear and allow students to redo answer or give an explanation of why the correct answer is correct -->

<!-- AJ: fix the 2 taus table in the 2nd tutorial so that tau is easier to calculate mentally -->

<!-- AJ: Causal vs predictive models has a typo -->

...
Virtually every problem boils down to attempting to answer a **question** about a **population** using **data**. We should explicitly state all 4 before we proceed, to make sure we understand the task at hand. 

...
<!-- Remove our defined functions like make_prop_red(). Reason is that we no longer teach how to write functions in chapter 3. (Same applies in tutorials.) Use shovel_size <- c(25, 50, 100)
reps <- 1:5
expand_grid(shovel_size, reps) and then just the code we have. -->
...
<!-- shovel_size <- c(25, 50, 100) -->
<!-- reps <- 1:5 -->
<!-- expand_grid(shovel_size, reps) -->

...
```{r, echo=FALSE, fig.cap="Mr. DeVito is correct: sampling *is* badass.", fig.margin = TRUE}
...
```{r, echo=FALSE, fig.cap="Fear not if you look like Spongebob after reading this section. We will re-cap right now!", fig.margin = TRUE}

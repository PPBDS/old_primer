...
>>>>>>> 7182c4dfb244215892d26ba3ac6aced3169036dc
...
Note that the beads do not have ID numbers printed on them. The numbering is arbitrary. Having an ID just reminds us that there are actual units under consideration, even if we can not tell them apart, other than by color.
...
The data we have, unfortunately, only provide the color for 50 out of the 1,000 beads.
...
=======
Consider why some beads do get sampled, while others do not. This is a consequence of the *sampling mechanism*. 
>>>>>>> 7182c4dfb244215892d26ba3ac6aced3169036dc
...
<!-- Use same rows (including same ID and Color) from Data table. -->
...
With the fitted model object `fit_1`, we can now answer the questions with which we began the project.

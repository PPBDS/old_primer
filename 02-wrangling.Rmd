...
<!-- AM: I disagree with removing the 538 portion. It provides a good demonstration of data "tidying" functions such as pivot_longer() -->
...
<!-- AM: Cover all join types shown here: https://dplyr.tidyverse.org/reference/join.html -->
...
<!-- AM: For someone following the primer verbatim, some of these packages will be missing. Notify the user to install any missing packages. -->
...
<!-- AM: It would look better if the hyperlink was for "Chapter 1" and not just "1". -->
<!-- AM: The explanations of each package would look much better as a bulleted list. -->
...
<!-- AM: argument*, also demonstrate a use of the "prop" argument -->

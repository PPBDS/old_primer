...
Note that 336,776 - 9,430 = 327,346, so `drop_na()` seems to check out. Be careful with `drop_na()`, however, because you may be removing rows with valuable data in other columns!

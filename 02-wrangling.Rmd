...
<!-- Read R For Data Science, especially parts directly relevant to this chapter: tibbles, characters, factors, dates/times, joining.  -->

<!-- Read Wrangling chapter in Modern Dive. -->
...
<!-- AM: Suggest combining 2.2 Characters, 2.3 Factors, and 2.5 Date-Times under its own part called "Object types", and 2.1 Tibbles and 2.4 Lists under its own part called "Data frame types", or something similar to that. Or just make it so that Lists isn't right in the middle of Factors and Date-Times -->

<!-- AM: The most important wrangling functions are already done in Chapter 1 and may be better-suited for their most in-depth use at chapter 2. -->
...
<!-- AM: Users may be missing a few of these packages. -->
<!-- AM: skimr does not seem as though it is used at all in this chapter. -->
...
The **tidyverse** package will be used in every chapter. Loading it makes the 8 packages from the "Tidyverse" available. **primer.data** is the data package created specifically for this primer. **lubridate** is a package for working with dates and times. **nycflights13** includes data associated with flights out of New York City's three major airports. **gapminder** has annual data for countries going back more than 50 years, which we used in Chapter \@ref(visualization). **fivethirtyeight** cleans up data from the [FiveThirtyEight](https://fivethirtyeight.com/) team.

<!-- AM: List these as bulleted lists so that they are easier to read. -->
<!-- AM: Deleted skimr as it is not used in this chapter and is better suited for chapter 1. -->
<!-- AM: 538's description is too vague. -->

## Tibbles

<!-- AM: This description of a tibble is unnecessarily wordy and confusing, especially when considering how much we use them in the primer. -->
...
<!-- AM: Just like above, this is unnecessarily wordy. I'd also suggest putting something like "let's make a tibble with columns a, b, c, and d, with values..." -->
...
<!-- AM: Is this entire tangent about having a number or space in the variable name necessary? Most programmers already go out of their way to avoid either. -->
...
<!-- AM: The first 3 sentences of this paragraph should preface the chapter. -->
...
<!-- AM: I say remove the raw strings part entirely. I'm not sure what purpose it serves. -->
...
<!-- DK: Very unclear, both string constants and back slashes. -->
...
<!-- AM: What in the "Tidyverse"? Awkward wording here -->
...
<!-- AM: Instead show a diagram of left_join() and briefly cover the rest of the joins, as left_join() is by far the most commonly-used join method -->
...
<!-- AM: Is this "code is equivalent to" part really necessary?  -->

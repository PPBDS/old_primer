...
<!-- Read chapters 4 through 7. Done -->

<!-- Add lots of comments to this Rmd with initials MM: -->

<!-- Do tutorials for chapter 4 and for chapter 8. -->

<!-- Old comments: -->

<!-- Where is the best place to modify income and discuss it? -->
...
<!-- MM: Was info on data discussed earlier? -->
...
<!-- DK: This whole section is very awkward. Start with which is data and which is parameters. 
     MM: Agree, found some parts of this a little difficult to follow -->
...
<!-- MM: touched on in the wisdom section in ch. 7, does it belong there? -->

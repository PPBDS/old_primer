...
<!-- Delete code rather comment it out. Students see code! And we can always get back old stuff via Github. Done. -->

<!-- When building the chapter, we don't want rayshader images to pop up! -->

<!-- Learn about movies in rayshader.  -->

<!-- Each of 2(Done) and 3(Done) and N model(Done.) section should begin with a question. All data science problems begin with a question. Then, the answer to that question, is the posterior which we create. -- Done.>


<!-- For the N model case only, we have a posterior and we should then use that posterior to do stuff, like what are the odds of at least 10 heads. Do it the way that chapter 6 does it by explicitly showing what it means to add up area under the curve. Done. -->
...
**Most people test positive are infected** This is a common result for common diseases like cold. We can easily create an unnormalized conditional distribution with:

...
<!-- Joint distribution in disease example and marble example are wrong. Change disease example so that we have 50% accurate if you have the diseases and 99% accurate if you don't. Done. -->
...
jd_marbles_plot <- jd_marbles %>%
  ...
  ggplot(aes(in_sample, in_bag, color = total)) +
    geom_point() +

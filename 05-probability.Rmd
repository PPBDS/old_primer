...
<!-- We need a fourth example, after Presidential elections, which is continuous. Presumably normal distribution. Perhaps using heigh of adults from nhanes for empirical. Then posterior is height at basketball court. Done. -->

<!-- Add copy button to tutorial in correct places. Done.-->

<!-- Read https://ppbds.github.io/primer.tutorials/articles/instructions.html Done. -->

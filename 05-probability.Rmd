...
<!-- Make this warning go away: Warning in make_shadow(heightmap, shadowdepth, shadowwidth, background, : `magick` package required for smooth shadow--using basic shadow instead. Done.-->

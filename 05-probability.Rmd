...
<!-- DK: Instead of after_stat(count/sum(count)), it looks like we could use after_stat(density), if we divide by the number of outcomes. Would that be an improvement? -->
...
In following figure, the order of your coin toss results does matter. Depending on your first result, you go down a different branch.

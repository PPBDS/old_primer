...
<!-- YW: Elaborate more on "The probability distribution is the Platonic Form" I found it hard to understand, I would say either explain more or simply deleted. Agreed! Elaborate! Stuff to talk about in the meetings (not good at philosophy), what is Platonic Form? something do with ideal version? How is that connected to probability and distribution?-->

<<<<<<< HEAD
<<<<<<< HEAD
<!-- Delete code rather comment it out. Students see code! And we can always get back old stuff via Github. Done. -->
=======
<!-- Need to add electoral votes for 2020. -->
>>>>>>> 714b1813cac3a1a8826031bbe23691e5d3794bb6

<!-- We need a fourth example, after Presidential elections, which is continuous. Presumably normal distribution. Perhaps using heigh of adults from nhanes for empirical. Then posterior is height at basketball court. -->
...
A good mathematical distribution for the height of adult men is the normal distribution.

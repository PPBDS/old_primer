...
<!-- Add, on the mathematical distribution sections, the actual math formual. Learn about putting math. $$x + 1$$ -->

<!-- When building the chapter, we don't want rayshader images to pop up! -->

<!-- Learn about movies in rayshader.  -->

<!-- What would be a fun theme/gif/movie clip to start and end the chapter with, like we do in chapters 4 and 6? Something having to do with betting . . . Connected to Kant? Done.-->
...
```{r, echo = FALSE}
knitr::include_app("https://www.youtube.com/watch?v=HtVHJsm1GME")
```
<!-- YW:Will add description (if I have time watch the movie) -->

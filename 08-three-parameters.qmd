...
Second, we need to evaluate what our units are for our situation. When taking a look at the Preceptor Table below: we can view that all our ID's are dependant on each individual. Our units for this scenario would be the individuals becuase there are several individuals at the station.
